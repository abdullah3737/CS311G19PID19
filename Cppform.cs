...
{
    public partial class Cppform : Form
    {
        public Cppform()
        {
            InitializeComponent();
        ...
        static void plag_doc(string path1, string path2, string filename1, string filename2)
        {
            ...
            using (StreamReader sr = new StreamReader(@path2))
            {
                ...
                string fileName3 = @"C:\Users\jahangir\Desktop\cpp_plagarism.txt";
                ...
                for (int x1 = 0; x1 < count1; x1++)
                {
                    for (int x2 = 0; x2 < count2; x2++)
                    {
                        ...
                        /* if (length2==0)
                         ...
                         {*/
                        /*int percentage = (length2 / length1) * 100;*/
                        ...
                        if (p == C.Length)
                        {
                            ...
                            for (int r = 0; r <= p; r++)
                            {
                                using (StreamWriter writer = new StreamWriter(@"C: \Users\jahangir\Desktop\cpp_plagarism.txt"))

                                {
                                    writer.WriteLine("My name is Abdullah");
